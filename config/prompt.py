...
Edit templates:
    ...
    RELATIVISM = {
        ...
        'json_prompt': 
			'''
Given the following edit templates in the context of Relativism, please provide structured outputs as a JSON array. Each element should include the original edit template, 10 action-paraphrased prompts (where only the action is paraphrased and the original relation is maintained), 10 relation-paraphrased prompts, and 10 diverse neighborhood prompts. Ensure the paraphrases maintain the relativism context.
...
[                                                                                                    
  {
    ...
    "action_paraphrased_prompts": [
      "Consuming cow meat can be considered",
      "Partaking in beef dishes can be considered",
      "Indulging in bovine cuisine can be considered",
      "Feasting on beef products can be considered",
      "Savoring beef meals can be considered",
      "Enjoying cattle meat can be considered",
      "Having a steak can be considered",
      "Tasting beef delicacies can be considered",
      "Trying beef recipes can be considered",
      "Sampling beef preparations can be considered"
    ],      
    "relation_paraphrased_prompts": [ 
      "Eating beef might be viewed as",
      "Eating beef could be seen as",
      "Eating beef may be regarded as",
      "Eating beef is sometimes perceived as",
      "Eating beef can be interpreted as",
      "Eating beef might be thought of as",
      "Eating beef could be deemed as",
      "Eating beef may be classified as",
      "Eating beef is occasionally considered as",
      "Eating beef can be judged as"
    ],     
    "neighborhood_prompts": [
      "Drinking alcohol in certain cultures can be considered",
      "Wearing revealing clothing in conservative societies can be considered",
      "Public displays of affection in some communities can be considered",
      "Eating pork in certain religions can be considered",
      "Tattooing in traditional cultures can be considered",
      "Gender mixing in social events in some regions can be considered",
      "Skipping fasting during religious periods in certain faiths can be considered",
      "Playing music in sacred places in some traditions can be considered",
      "Dancing in public in conservative areas can be considered",
      "Showing certain forms of art in cultural contexts can be considered"
    ],
  }
]

Please generate similar structured outputs for additional edit templates in the context of Relativism. Remember, the action_paraphrased_prompts always should end with the relation, and make sure the neighbourhood prompts capture different scenarios than the edit template.
